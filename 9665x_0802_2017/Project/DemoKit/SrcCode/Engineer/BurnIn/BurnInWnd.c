...
void BurnIn_DrawLoopCount(BOOL bClear)
{
    if (g_bBurnInWndOpen)
    {
        ...
        snprintf(cLoopCountStr, sizeof(cLoopCountStr), "Loop: %d   ", (int)g_uiLoopCount);
...
void BurnIn_DrawTime(UINT32 uiTime)
{
    ...
    snprintf(cTimeStr, sizeof(cTimeStr), "%02d:%02d:%02d  ", (int)uiTime/3600, (int)(uiTime%3600)/60, (int)(uiTime%3600)%60);
...
EVENT_ITEM(NVTEVT_KEY_LEFT,BurnInWnd_OnKeyShutter2)
EVENT_ITEM(NVTEVT_KEY_UP,BurnInWnd_OnKeyUp)
EVENT_ITEM(NVTEVT_KEY_DOWN,BurnInWnd_OnKeyDown)
EVENT_ITEM(NVTEVT_KEY_ENTER,BurnInWnd_OnKeyPower)
