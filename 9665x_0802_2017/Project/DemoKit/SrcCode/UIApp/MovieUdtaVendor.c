...
BOOL MovieUdta_MakeVendorUserData(UINT32 *UDtaAddr, UINT32 *UDtaSize)
{
    ...
    *UDtaSize = DscMovie_MakeUserMakerModelData(gUserMakerModelDataBuf,
                                                gAppMovieManuNameStr,
                                                sizeof(gAppMovieManuNameStr),
                                                gAppMovieCompNameStr,
                                                sizeof(gAppMovieCompNameStr));
