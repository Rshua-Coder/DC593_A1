...
//drh add wifi icon display function 20170915
extern void FlowWifiMovie_UpdateIcons(BOOL bShow);
extern void FlowWifiMovie_IconDrawDateTime(void);
extern void FlowWifiMovie_IconHideDateTime(void);
extern void FlowWifiMovie_DrawWifi(VControl *pCtrl);
extern void FlowWifiMovie_HideWifi(VControl *pCtrl);
