...
#define    BURSTKEY_DEBOUNCE     1600//ms
...
{
    //POWER KEY
    {FLGKEY_KEY_POWER,    KEY_PRESS,       NVTEVT_KEY_POWER,        0,                DEMOSOUND_SOUND_KEY_TONE},
    ...
    {FLGKEY_MENU,         KEY_PRESS,       NVTEVT_KEY_MENU,         NVTEVT_KEY_PRESS,     DEMOSOUND_SOUND_KEY_TONE},// useful
    ...
    {FLGKEY_UP,           KEY_PRESS,       NVTEVT_KEY_UP,           NVTEVT_KEY_PRESS,     DEMOSOUND_SOUND_KEY_TONE},//useful
    {FLGKEY_UP,           KEY_CONTINUE,    NVTEVT_KEY_UP,           NVTEVT_KEY_CONTINUE,  0},
    {FLGKEY_UP,           KEY_RELEASE,     NVTEVT_KEY_UP,           NVTEVT_KEY_RELEASE,   0},
    
    {FLGKEY_DOWN,         KEY_PRESS,       NVTEVT_KEY_DOWN,         NVTEVT_KEY_PRESS,     DEMOSOUND_SOUND_KEY_TONE},//useful
...
INT32 System_UserKeyFilter(NVTEVT evt, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    else if(IN_RANGE_EVENT(key, NVTEVT_KEY_BUTTON_START, NVTEVT_KEY_BUTTON_END)) //Button class
    {
        ...
        {
             if(key == NVTEVT_KEY_POWER_CONT)//drh 20170919
            {
            	debug_msg("^Y ---> NVTEVT_KEY_POWER_CONT \r\n");
            	uiPower_Count ++ ;
				if(uiPower_Count > 10)
				{			
        ...
        else if(IN_RANGE_EVENT(key, NVTEVT_KEY_RELEASE_START, NVTEVT_KEY_RELEASE_END)) //Release key
        {
            if(key == NVTEVT_KEY_POWER_REL)
            {
                ...
                else
                {
                    ...
                    //System_PowerOff(SYS_POWEROFF_NORMAL);
                    Ux_PostEvent(NVTEVT_KEY_SHUTTER2, 1,NVTEVT_KEY_PRESS);//drh 20170919
                }
                return NVTEVT_CONSUME;
            }
