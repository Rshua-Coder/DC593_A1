...
extern UINT32 iShow_VDO1;
extern BOOL bShow_VDO1;
extern UINT32 iShow_VDO2;
extern BOOL bShow_VDO2;
extern UINT32 iShow_OSD1;
extern BOOL bShow_OSD1;
extern UINT32 iShow_OSD2;
extern BOOL bShow_OSD2;
...
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -begin
#if _DEMO_TODO
UINT32 bFirstOSD1 = TRUE;
UINT32 bFirstOSD2 = TRUE;
#endif
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -end

UINT32 iShow_VDO1 = 0xFFFFFFFF;
BOOL bShow_VDO1 = FALSE;
UINT32 iShow_VDO2 = 0xFFFFFFFF;
BOOL bShow_VDO2 = FALSE;
UINT32 iShow_OSD1 = 0xFFFFFFFF;
BOOL bShow_OSD1 = FALSE;
UINT32 iShow_OSD2 = 0xFFFFFFFF;
BOOL bShow_OSD2 = FALSE;

extern BOOL bForceOff_VDO2;
...
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -begin
            if(bFirstOSD2)
            {
            UI_SetDisplaySource(LAYER_OSD1, (UINT32)View_Window);
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD1COMPARE, COMPARE_KEY_EQUAL); //enable OSD1/OSD2 color key
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD1COLORKEY, 0); //set color key index
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD1ALPHA, OSD_OPAQUE_100); //set blending OSD1=0%, OSD2=100%
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD1BLEND, BLEND_PIXELALPHA); //OSD1 do blending over on VDO2 = BLEND_DISABLE/CONSTALPHA/PIXELALPHA
            bFirstOSD2 = FALSE;
            }
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -end
        }
...
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -begin
            if(bFirstOSD1)
            {
            UI_SetDisplaySource(LAYER_OSD1, (UINT32)View_Info);
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD2COMPARE, COMPARE_KEY_EQUAL); //enable OSD1/OSD2 color key
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD2COLORKEY, 0); //set color key index
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD2ALPHA, OSD_OPAQUE_100); //set blending OSD1=0%, OSD2=100%
            GxDisplay_Set(LAYER_OUTPUT, CTRL_STATE_OSD2BLEND, BLEND_PIXELALPHA); //OSD2 do blending over on OSD1 = BLEND_DISABLE/CONSTALPHA/PIXELALPHA
            bFirstOSD1 = FALSE;
            }
//#NT#2010/04/15#Jeah Yen -FASTBOOT- -end
        }
