...
#define OSD_USE_ROTATE_BUFFER           ENABLE //support rotate screen //drh mark 20170927
...
#define WIFI_APP_MANUFACTURER           "Novatek"
...
#define WIFI_STA_RECONNECT_INTERVAL  600 //150 Could be adjusted by project.
