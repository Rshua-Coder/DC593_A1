...
#define DBGUT_DMA_CH_GROUP_CNT 4 ///< Total DAM group counts
...
extern DBGUT_ER DbgUt_CmdOs(const DBGUT_CMD_OS Cmd,const DBGUT_CMD_DATA* pData); ///< Do related OS command
//@}
