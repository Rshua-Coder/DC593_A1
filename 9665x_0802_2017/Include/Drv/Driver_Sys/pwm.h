...
#define pwm_en              pwm_pwmEnable
#define pwm_stop            pwm_pwmDisable
#define pwm_set             pwm_pwmConfig
#define pwm_setEn           pwm_pwmEnableSet
#define pwm_setStop         pwm_pwmDisableSet
#define pwm_msSetClockDiv   pwm_configClockDivSet
#define pwm_msChannelEn     pwm_mstepEnable
#define pwm_msSetEn         pwm_mstepEnableSet
#define pwm_msChannelStop   pwm_mstepDisable
#define pwm_msSetStop       pwm_mstepDisableSet
#define pwm_ccnt_en         pwm_ccntEnable
#define pwm_msChannelConfig pwm_mstepConfig
#define pwm_msSetConfig     pwm_mstepConfigSet
#define pwm_msSetClose      pwm_closeSet
/**
    @addtogroup mIIOPWM
*/
//@{
...
/**
    PWM phase type (1-2 or 2-2 phase)
...
extern UINT32   pwm_getCycleNumber(UINT32 uiPWMId);
...
extern ER       pwm_configClockDivSet(PWM_MS_CHANNEL_SET uiMSSet, UINT32 uiDiv);
