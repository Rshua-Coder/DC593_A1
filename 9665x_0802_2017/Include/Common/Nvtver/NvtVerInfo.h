...
const CHAR __module_name__ [] VERSION_INFO_ID4(__section_name__, _major, _minor, _bugfix, _ext)  = __xstring(__section_name__) "#" __xstring(_major) "." __xstring(_minor) "." __xstring(_bugfix) "." __xstring(_PROJECT_CODE_) "." __xstring(_ext) "_"  __DATE__ ", " __TIME__;
...
#define NVTVER_VERSION_ENTRY(_l, _major, _minor, _bugfix, _ext)  \
const CHAR __module_name__ [] VERSION_INFO_ID4(__section_name__, _major, _minor, _bugfix, _ext)  = __xstring(__section_name__) "#" __xstring(_major) "." __xstring(_minor) "." __xstring(_bugfix) "_"  __DATE__ ", " __TIME__;
