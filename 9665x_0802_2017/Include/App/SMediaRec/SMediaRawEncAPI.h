...
/**
    ...
    @code
    {
        ...
        SMRawEnc_ChangeParameter(SMRAWENC_JPEG_WIDTH,  1920, 0, 0);
        SMRawEnc_ChangeParameter(SMRAWENC_JPEG_HEIGHT, 1080, 0, 0);
        SMRawEnc_ChangeParameter(SMRAWENC_JPEG_WIDTH,  1920, 1, 0);
        SMRawEnc_ChangeParameter(SMRAWENC_JPEG_HEIGHT, 1080, 1, 0);

        rawreturn = SMRawEnc_TriggerEncode(SMRAW_FORMAT_ALLPATH, 0);
    }
    @endcode
*/
