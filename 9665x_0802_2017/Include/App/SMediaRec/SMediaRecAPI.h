...
#define     SMEDIAREC_GETINFO_PATHOPEN       MOVREC_GETINFO_PATHOPEN      ///< p1: pathid (in), p2: onoff(out)
//@}
...
extern void SMediaRec_ForceAllAlloc(void);
extern void SMediaRec_SetDeleteOldByNum(UINT32 value);
