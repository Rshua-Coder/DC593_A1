...
typedef enum _IMG_CAP_CBMSG
{
    ...
    IMG_CAP_CBMSG_SET_EXIF_DATA,        ///< exif CB command, data type IMG_CAP_EXIF_DATA.
...
/************** IMG_CAP_CBMSG_SET_EXIF_DATA **************/
/**
    exif callback information
*/
typedef struct _IMG_CAP_EXIF_DATA
{
    IPL_PROC_ID Id;         ///< id
} IMG_CAP_EXIF_DATA;
...
{
    IPL_PROC_ID Id;                 ///< only valid on dual sensor capture mode
