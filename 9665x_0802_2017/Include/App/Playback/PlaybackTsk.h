...
#define PBFMT_MPO                   0x00000200  ///< File format: MPO
#define PB_SUPPORT_FMT              (PBFMT_JPG|PBFMT_WAV|PBFMT_AVI|PBFMT_MOVMJPG|PBFMT_ASF|PBFMT_MPG|PBFMT_MPO) ///< Default file format for Playback
//@}
...
typedef enum _PB_EDIT_IMAGE
{
    ...
    PBEDIT_NLIGHT_DISP,                 ///< Set Nova-Light for display only
    PBEDIT_NLIGHT,                      ///< Set Nova-Light and save file
...
/**
    ...
    -# #PBEDIT_NLIGHT_DISP must be called prior to #PBEDIT_NLIGHT command in order to configure relevant Nova-light parameters.
    ...
    @param[in] pConfig Pointer to the Playback Edit Image configuration structure: #_PB_EDIT_CONFIG.
        - @b Operation - The operation to be performed:
            ...
            - @b #PBEDIT_NLIGHT_DISP
                - @b puiParam[0] The level of Nova-light.
            - @b #PBEDIT_NLIGHT
                - @b puiParam[0] If overwrite the currently file.
...
/**
    ...
    @code
    {
        PB_SetExpectJPEGSize(12, 15, 15, 5);
