...
#define MOVREC_VIDBS_REVSEC       2//4           //reserved 4 sec BS//2015/06/17 5->4
#define MOVREC_FAKE_H264BS_BUF    0x64000 //400K

#define MOVREC_VIDBS_REVSEC_S     1           //reserved 3 sec BS

#define MOVREC_VIDBS_NUMINBS      5 //if not tiny = 6+4
#define MOVREC_VIDBS_NUMINBS_S    3  //if tiny = 3+3
...
#define     MOVREC_IMMPROC_FILEFINISH         4  ///< end of one file, p1:pathID
//@}
...
#define MOVREC_RECPARAM_OVERLAP_ON        0x35 ///< overlap on/off, p1 0 or 1 (default:on)
...
#define     MOVREC_EVENT_PCMAAC_CB            36
#define     MOVREC_EVENT_AUDPCM_CB            37
...
#define     MOVREC_EVENT_CUTNOW_FAIL          0x92 ///callback if cutnow fails
