...
/**
    Enable/disable EMRloop for path0/1
    (If EMR is disable, do nothing!!)
...
/**
    ...
    @return void
*/
extern void MovRec_GetLastPCMAAC_BS(MEDIAREC_MEM_RANGE* frameBuf);
...
/**
    ...
    @return void
*/
extern void MovRec_SetCutNOW(void);
...
/**
    Force all files alloc.

    @param[in] void
    @return void
*/
extern void MovRec_ForceAllAlloc(void);

/**
    Set deleteRO by number

    @param[in] value: project layer should handle.
    @return void
*/
extern void MovRec_SetDeleteOldByNum(UINT32 value);
