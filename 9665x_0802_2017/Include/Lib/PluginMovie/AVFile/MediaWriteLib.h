...
typedef enum
{
    ...
    MEDIANAMING_SETINFO_OPENDEBUGMSG    = 0x04, ///< p1: 1 on
    ...
    MEDIANAMING_SETINFO_SETNOWPATHID    = 0x86,
...
*/
//@{
#define MEDIANR_CUSTOM_CHANGECRASH      0x01 ///< p1: CHAR *pPath (in/out), p2:pathid
