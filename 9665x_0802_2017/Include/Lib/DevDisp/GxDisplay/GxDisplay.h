...
//TODO: remove this obsoluted func
...
*/
extern void GxDisplay_SetSrcWindow  (UINT32 LayerID, LVALUE x, LVALUE y, LVALUE w, LVALUE h);
...
*/
extern void GxDisplay_SetDestWindow (UINT32 LayerID, LVALUE x, LVALUE y, LVALUE w, LVALUE h, UINT32 uiMirror);
...
*/
extern DC*  GxDisplay_BeginDraw     (UINT32 LayerID);
...
*/
extern void GxDisplay_EndDraw       (UINT32 LayerID, DC* pLayerDC);
...
*/
/*
extern void GxDisplay_SetOrder      (UINT32 uiOrder, UINT32 uiAlphaBlend, UINT32 uiColorKey);
*/
#define GxDisplay_SetOrder(a,b,c)   //NOT SUPPORT ANY MORE!
