...
typedef struct _GXVIDEO_INFO
{
    ...
    UINT32           uiUserDataAddr;         ///<[out] User Data Position in File
    UINT32           uiUserDataSize;         ///<[out] User Data Size
    UINT32           uiFre1DataAddr;         ///<[out] Fre1 Data Position in File
    UINT32           uiFre1DataSize;         ///<[out] Fre1 Data Size
    UINT32           uiThumbOffset;          ///<[out] Thumbnail offset, from the start of video file
    ...
    UINT32           uiScraOffset;           ///<[out] Screennail offset, from the start of video file
...
*/
typedef  ER(* FPGXVIDEO_GETHUMBCB)(UINT32 userdata_buf, UINT32 userdata_size, UINT32 *thumb_pos, UINT32 *thumb_size);
...
*/
GXVID_ER GxVidFile_Query1stFrameWkBufSize(UINT32 *uipBufferNeeded, UINT32 uiTotalFileSize);
...
/**
    ...
    @return
     - @b GXVIDEO_PRSERR_OK:     Query successfully.
*/
GXVID_ER GxVidFile_QueryThumbWkBufSize(UINT32 *uipBufferNeeded, UINT32 uiTotalFileSize);
...
*/
GXVID_ER GxVidFile_DecodeThumbFrame(FPGXVIDEO_READCB fpReadCB, PMEM_RANGE pWorkBuf, PIMG_BUF pDstImgBuf);
...
*/
GXVID_ER GxVidFile_ParseVideoInfo(FPGXVIDEO_READCB fpReadCB, PMEM_RANGE pWorkBuf, UINT32 uiTotalFileSize, PGXVIDEO_INFO pVideoInfo);
//@}
