...
*/
#define WAVFILE_ASF_ENABLE      DISABLE //ENABLE
...
/**
    ...
    @param[out] pFileSize   Current size of a size

    @return Write header status.
        - @b WAV_STATUS_INVALID_PARAM: Invalid WAV file information
        - @b WAV_STATUS_OK: Write OK
*/
extern UINT32 WAVWriter_WriteHeader(PWAV_FILEINFO pWAVFileInfo, UINT32 uiAddr, UINT32 *pFileSize);
...
/**
    ...
    @param[in] uiBufAddr    The address of WAV data (PCM or ADPCM) that you want to write
    @param[in] uiDataSize   WAV data size that you want to save
    @param[out] pFileSize   Current size of a size
    ...
    @return Write data status
        ...
        - @b WAV_STATUS_OK: Write OK
*/
extern UINT32 WAVWriter_WriteData(UINT32 uiBufAddr, UINT32 uiDataSize, UINT32 *pFileSize);
...
/**
    ...
    @param[in] isSync       File System reads in data synchronously or asynchronously.
