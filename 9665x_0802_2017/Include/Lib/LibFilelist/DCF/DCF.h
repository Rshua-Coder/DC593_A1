...
*/
extern BOOL   DCF_AddDBfile(CHAR *filePath);
...
*/
extern BOOL   DCF_DelDBDir(CHAR *filePath);
...
*/
extern BOOL   DCF_DelDBfile(CHAR *filePath);

//DCF filename & type
//extern void   DCF_SetFreeChars(UINT32 bDir, UINT32 bOperation, CHAR baChars[]);                              // This function enables the host to set the DCF free characters to be used in file names created.
                                                                                                             // the bOperation is defined DCF_CHARS_XXXX
/**
...
/**
     ...
     @endcode
*/
extern BOOL   DCF_MakeDirPath(UINT32  DirID, CHAR *Path);
/**
     ...
     @endcode
*/
extern BOOL   DCF_MakeObjPath(UINT32  DirID, UINT32 FileID, UINT32 fileType, CHAR *filePath);
...
*/
extern INT32  DCF_IsValidFile(char *pFileName, UINT32 *pType);
...
*/
extern UINT32 DCF_GetDBInfo(DCF_INFOID infoID);
...
*/
extern UINT32 DCF_GetOneTypeFileCount(UINT32 fileType);
...
*/
extern BOOL   DCF_GetDirInfo(UINT32 DirID, PSDCFDIRINFO psDirInfo);
...
*/
extern BOOL   DCF_GetDirPath(UINT32 DirID,CHAR *Path);
...
*/
extern BOOL   DCF_GetObjInfo(UINT32  index, UINT32* DirID, UINT32* FileID, UINT32* fileType);
...
*/
extern BOOL   DCF_GetObjPath(UINT32  index, UINT32 fileType, CHAR *filePath );
...
/**
     ...
     @return
         ...
         - @b FALSE:   Get object path fail, input index out of range.
*/
extern BOOL   DCF_GetObjPathByID(UINT32 DirID, UINT32 FileID, UINT32 fileType, CHAR *filePath );
...
*/
extern BOOL   DCF_GetLastObjInfo(UINT32* DirID, UINT32* FileID, UINT32* fileType);
...
extern BOOL   DCF_GetLastObjPath(UINT32 fileType, CHAR *filePath );
...
*/
extern UINT32 DCF_GetIndexByID(UINT32 DirID, UINT32 FileID);
...
*/
extern BOOL   DCF_SetCurIndex(UINT32 index);
...
*/
extern UINT32 DCF_SeekIndex(INT32 offset, DCF_SEEK_CMD seekCmd);
...
/**
     ...
     @return  result index,  return 0 means seek index fail.
*/
extern UINT32 DCF_SeekIndexByID(UINT32 DirID, UINT32 FileID);
...
*/
extern BOOL   DCF_GetNextID(UINT32 *DirID,UINT32 *FileID);
...
*/
extern BOOL   DCF_SetNextID(UINT32 DirID,UINT32 FileID);
...
/**
     ...
     @return
         ...
         - @b FALSE:   Get next id fail, the DCF max object 999-9999 is exist.
*/
extern BOOL   DCF_LockNextID(UINT32 *DirID,UINT32 *FileID);

/**
     Unlock DCF next write DirID , FileID.

*/
extern void   DCF_UnlockNextID(void);

/**
     Dump DCF Database related information.

*/
extern void   DCF_DumpInfo(void);
...
*/
extern void   DCF_RegisterCB(DCF_CBMSG_FP CB);
//@}
#endif  //_DCF_H_
