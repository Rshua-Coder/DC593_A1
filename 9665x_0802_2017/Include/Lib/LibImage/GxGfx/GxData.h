...
//--------------------------------------------------------------------------------------
/**
     Load JPG bitstream to Image DC

     @param[out] pImage            Pointer of image
     @param[in] uiJPGData          JPG bitstream addr
     @param[in] uiJPGSize          JPG bitstream size
     @return
        - @b GX_OK if success
        - @b GX_NULL_POINTER no image pointer
*/
...
/**
     Get image size from jpg bitstream
     ...
     @return
        - @b GX_OK if success
        - @b GX_UNKNOWN_FORMAT unknow jpg bitstream data format
*/
