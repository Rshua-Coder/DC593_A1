...
// Usage:   #include <cyg/cpuload/cpuload.h>
...
__externC void          cyg_cpuload_start(void);

// Get the current CPU load since last start
// Return value 0 ~ 100, means 0 ~ 100%
__externC cyg_uint32    cyg_cpuload_get(void);
