...
// ======== 0x500 USB =======================================================
// Get/Set configuration 'key' values for USB
 
#define CYG_IO_GET_PHY_SEC_SIZE                  0x501
#define CYG_IO_GET_WRITE_PROTECTED               0x502
#define CYG_IO_GET_DEV_VID                       0x503
#define CYG_IO_GET_DEV_PID                       0x504
#define CYG_IO_GET_DEV_PORTNUM                   0x505
...
#define CYG_IO_GET_CONFIG_DISK_PROBE             0x701

#define CYG_IO_SET_CONFIG_DISK_MOUNT             0x781
#define CYG_IO_SET_CONFIG_DISK_UMOUNT            0x782
#define CYG_IO_SET_CONFIG_DISK_DISCONNECT        0x783
#define CYG_IO_SET_CONFIG_DISK_FORMAT            0x784
#define CYG_IO_SET_CONFIG_DISK_FDISK             0x785
#define CYG_IO_SET_CONFIG_DISK_DELETE_ALL        0x786

#define CYG_IO_SET_CONFIG_DISK_SUSPEND			 0x787
#define CYG_IO_SET_CONFIG_DISK_RESUME			 0x788
