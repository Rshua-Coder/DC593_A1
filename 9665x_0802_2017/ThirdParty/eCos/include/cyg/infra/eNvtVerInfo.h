...
//#define _PROJECT_CODE_  A0D1
    ...
    const CHAR _l##_LIBRARY_VERSION_INFO[]     NVTVER_ID3(_l,_major,_minor,_bugfix, _ext)   = __xstring(_l) "#" __xstring(_major) "." __xstring(_minor) "." __xstring(_bugfix) "." __xstring(_PROJECT_CODE_) "." __xstring(_ext) "_" __DATE__ ", " __TIME__;
#else
  #ifndef NVTVER_ID3
    #define NVTVER_ID3( _name, _major, _minor, _bugfix, _ext ) \
    ...
    // Macro to generate version and build date information
    #define NVTVER_VERSION_ENTRY(_l, _major, _minor, _bugfix, _ext)  \
    const CHAR _l##_LIBRARY_VERSION_INFO[]     NVTVER_ID3(_l,_major,_minor,_bugfix, _ext)   = __xstring(_l) "#" __xstring(_major) "." __xstring(_minor) "." __xstring(_bugfix) "_" __DATE__ ", " __TIME__;
#endif
