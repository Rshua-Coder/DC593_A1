...
#define PTHREAD_RWLOCK_MAGIC        0xfacade2
...
__externC int pthread_rwlockattr_init(pthread_rwlockattr_t *attr);
__externC int pthread_rwlockattr_destroy(pthread_rwlockattr_t *attr);

__externC int pthread_rwlockattr_setpshared(pthread_rwlockattr_t *attr,
                                            int pshared);
__externC int pthread_rwlockattr_getpshared(const pthread_rwlockattr_t *attr,
                                            int *pshared);

__externC int pthread_rwlock_init(pthread_rwlock_t *rwlock,
                                  const pthread_rwlockattr_t *attr);
__externC int pthread_rwlock_destroy(pthread_rwlock_t *rwlock);

__externC int pthread_rwlock_tryrdlock(pthread_rwlock_t *rwlock);
__externC int pthread_rwlock_rdlock(pthread_rwlock_t *rwlock);
__externC int pthread_rwlock_trywrlock(pthread_rwlock_t *rwlock);
__externC int pthread_rwlock_wrlock(pthread_rwlock_t *rwlock);

__externC int pthread_rwlock_unlock(pthread_rwlock_t *rwlock);
