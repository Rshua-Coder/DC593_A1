#ifndef CYGONCE_DEVS_SPI_MIPS_NT96650_H
#define CYGONCE_DEVS_SPI_MIPS_NT96650_H
//==========================================================================
//
//      spi_nt96650.h
//
//      Novatek NT96650 (MIPS) SPI driver defines
//
//==========================================================================
...
typedef struct cyg_spi_nt96650_bus_s
{
    // ---- Upper layer data ----
...
} cyg_spi_nt96650_bus_t;

//-----------------------------------------------------------------------------
// NT96650 SPI DEVICE

typedef struct cyg_spi_nt96650_device_s
{
    // ---- Upper layer data ----
    ...
    cyg_uint8  lsb;             // LSB (of a byte) transmit first
    cyg_uint32 freq;            // Clock frequency (unit: Hz)
...
} cyg_spi_nt96650_device_t;

//-----------------------------------------------------------------------------
// AT91 SPI exported busses

/* For backwards compatability  */
#define cyg_spi_nt96650_bus cyg_spi_nt96650_bus0

externC cyg_spi_nt96650_bus_t cyg_spi_nt96650_bus0;
externC cyg_spi_nt96650_bus_t cyg_spi_nt96650_bus1;


//-----------------------------------------------------------------------------

#endif // CYGONCE_DEVS_SPI_MIPS_NT96650_H

//-----------------------------------------------------------------------------
// End of spi_nt96650.h
