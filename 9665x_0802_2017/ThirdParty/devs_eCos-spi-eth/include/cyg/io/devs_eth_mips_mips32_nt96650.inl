//==========================================================================
//
//      devs/eth/mips/nt96650/include/devs_eth_mips_mips32_nt96650.inl
//
...
#ifdef CYGPKG_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0

static pcnet_priv_data amd_pcnet_eth0_priv_data = { 
#ifdef CYGSEM_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_SET_ESA
    esa : CYGDAT_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_ESA,
    hardwired_esa : true,
#else
    hardwired_esa : false,
#endif
    config_esa : NULL,
    rx_ring : NULL,
    rx_ring_cnt : (1<<2) /*CYGNUM_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_RX_RING_SIZE*/,
    rx_ring_log_cnt : 2,
    tx_ring : NULL,
    tx_ring_cnt : (1<<2) /*CYGNUM_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_TX_RING_SIZE*/,
    tx_ring_log_cnt : 2,
};

ETH_DRV_SC(amd_pcnet_sc,
           &amd_pcnet_eth0_priv_data, // Driver specific data
           CYGDAT_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_NAME,
           pcnet_start,
           pcnet_stop,
           pcnet_control,
           pcnet_can_send,
...
NETDEVTAB_ENTRY(pcnet_netdev, 
                "pcnet_" CYGDAT_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0_NAME,
                amd_pcnet_init, 
                &amd_pcnet_sc);
#endif // CYGPKG_DEVS_ETH_MIPS_MIPS32_NT96650_ETH0
...
// EOF devs_eth_mips_mips32_nt96650.inl
