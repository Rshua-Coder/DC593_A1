/**
    ...
    @file       ae_NT99231_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_NT99231_EVB_FF_INT_H_
#define _AE_NT99231_EVB_FF_INT_H_
...
#define AE_EXPECT_Y                 (50<<4)                     ///< expectY
#define AE_MIN_ISO                  75                          ///< min iso
//#define AE_MAX_ISO                  (AE_MIN_ISO*6)              ///< max iso
#define AE_MAX_ISO                  (AE_MIN_ISO*12)              ///< max iso
...
#define AE_EXPECT_Y_NIGHT           (AE_EXPECT_Y >> 1) //(10<<4)                     ///< expect Y night
