/**
    ...
    @file       ae_GC2023P_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_GC2023P_EVB_FF_INT_H_
#define _AE_GC2023P_EVB_FF_INT_H_
...
#define AE_MOV_EXPECT_Y             480                         ///< expectY 100 //for video recording
#define AE_PHOTO_EXPECT_Y         480//  512                         ///< expectY 128 //for photo mode
