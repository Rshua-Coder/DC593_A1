...
static void AE_SetMovieLog(char* Buf, UINT32 BufLen)
{
    ...
    sprintf(Buf, "%3d %3d %3d %3d %3d %3d %3d %3d %d %d %d %d %d %d %d %d %d %d %d 04\0",
                                                                    AeInfo.PrvAvgLum.y,
...
void AE_getInfo(AE_INFO2 *AeInfo)
{
    ...
    AeInfo->ConvSpeed = AEALG_SPEED_N2;
    AeInfo->ConvTab = NULL;
