#ifndef _IQS_SETTINGFLOW_NT99231_EVB_FF_C
#define _IQS_SETTINGFLOW_NT99231_EVB_FF_C
...
static char     IQS_NT99231M_VerInfo[]    = "20140606A";
static char     IQS_NT99231M_BuildDate[]  = __DATE__ ", " __TIME__;
extern UINT32 ISORatio;
/*
UINT8 IQ_Gamma_Cnt = 0;
UINT8 DG_cycle = 5;
UINT32 GammaTab[130];
BOOL ifFirstDynamicGamma = TRUE;
*/
///////////////////////////////////////////////
// Body
///////////////////////////////////////////////
...
/*
void IQS_GetDynamicGamma(void)
{
    UINT32 index;
    if(ifFirstDynamicGamma == TRUE)
    {
        for(index=0; index<130; index = index+1)
        {
           GammaTab[index] = GammaLUT_128Tab[index] + ((ISORatio * (GammaLUT_128Tab_Dark[index] - GammaLUT_128Tab[index]))>>8);
        }
     ifFirstDynamicGamma = FALSE;
    }

    IQ_Gamma_Cnt++;
    IQ_Gamma_Cnt = IQ_Gamma_Cnt%DG_cycle;
    if(IQ_Gamma_Cnt != 0)
    return;
    for(index=0; index<130; index = index+1)
    {
...
static ER PRE_IQparam(IQS_FLOW_MSG MsgID, PRE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    DBG_ERR("Zoom_Value=%d, SenMode_Value=%d,ISO_Value=%d\r\n", Zoom_Value, SenMode_Value, ISO_Value);
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PREIME_D2D_PRE_QV:
            //enable function
            subf->preFuncEn |= (
                                 VigEn              ///< enable function: Vignette shading compensation
                                 );
...
static ER IPE_IQparam(IQS_FLOW_MSG MsgID, IPE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PREIME_D2D_IPE_QV:
            ...
            IQ_IPE_YCCcon.YCon = ColorEffectTable_Normal.YCon + Contrast[Contrast_Value];
            IQ_IPE_YCCcon.UVCon = ColorEffectTable_Normal.CCon;
            ...
            //////////////////
            //IQS_GetDynamicGamma();
         //IQ_IPE_RGBGAMMA.GammaTbl_TblAddr = (UINT32)IPE_GammaReorgon((UINT32 *)GammaTab, (UINT32 *)GammaTab, (UINT32 *)GammaTab);
...
ER IQCB_SettingFlowFunc(IQS_FLOW_MSG MsgID, ENG_SUBFUNC *Info, IPL_HAL_GROUP* group)
{
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PRV_SIE_INIT:
            IQS_SetVerInfo(IQS_NT99231M_VerInfo);
            IQS_SetBuildDate(IQS_NT99231M_BuildDate);
            break;
