...
const UINT32 VDOZOOM_TVP5150_INFOR_MODE_TABLE[2][DZOOM_ITEM_MAX] =
{
    //sie       sie
    //crop out  ch0 out    pre in
    {1440, 240, 1440, 240, 1440, 240},
    {1440, 288, 1440, 288, 1440, 288}
    //{720, 120, 720, 120, 720, 120}
};

#if 1
const UINT32 VDOZOOM_VIRTUAL_INFOR_MODE_1_TABLE[1][DZOOM_ITEM_MAX] =
{
    {  640,  360,  640,  360,  640,  360},
};

const UINT32 VDOZOOM_VIRTUAL_INFOR_MODE_2_TABLE[1][DZOOM_ITEM_MAX] =
{
        ...
        switch(SenMode)
        {
            case SENSOR_MODE_1:
                ...
                *DzMaxidx = (sizeof(VDOZOOM_TVP5150_INFOR_MODE_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
            case SENSOR_MODE_2:
                Ptr = (UINT32*)&VDOZOOM_TVP5150_INFOR_MODE_TABLE[1][0];
                *DzMaxidx = (sizeof(VDOZOOM_TVP5150_INFOR_MODE_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
