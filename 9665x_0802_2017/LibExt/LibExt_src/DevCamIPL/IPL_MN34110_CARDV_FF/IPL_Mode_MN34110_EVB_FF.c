       ...
       case IPL_MODE_VIDEO:
          switch(Video_FPS)
          {
              case SEL_VIDEOFPS_30:
                  IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_9);
                  break;
            ...
            SetCalSensorMode(SENSOR_MODE_9);
            break;
        ...
        default:
            ...
            IPL_AlgSetUIInfo(IPL_SEL_CAPSENMODE, SENSOR_MODE_UNKNOWN);
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_UNKNOWN);
            break;
    }
...
static ER IPL_Off2Prv(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    else
    {
        ...
        AeObj.EventTab[IPL_UTI_CONV2_AE_ID(IPL_ID_1)].Start = AE_Init;
        AeObj.EventTab[IPL_UTI_CONV2_AE_ID(IPL_ID_1)].Process = AE_Process;
        AeObj.EventTab[IPL_UTI_CONV2_AE_ID(IPL_ID_1)].Pause = AE_Suspend;
...
static ER IPL_Cap2Prv(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    IPL_MapSensorMode(ChgMode, PrvMode); // add for calibaration
