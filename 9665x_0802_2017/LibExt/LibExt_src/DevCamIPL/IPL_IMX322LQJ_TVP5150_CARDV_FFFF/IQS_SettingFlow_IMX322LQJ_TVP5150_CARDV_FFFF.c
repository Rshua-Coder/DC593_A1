#ifndef _IQS_SETTINGFLOW_IMX322LQJ_TVP5150_CARDV_FFFF_C
#define _IQS_SETTINGFLOW_IMX322LQJ_TVP5150_CARDV_FFFF_C
#include "IPL_IMX322LQJ_TVP5150_CARDV_FFFF_Int.h"
#include "ae_alg.h"
...
static void IQS_Gamma_Intpl(UINT32* G1, UINT32* G2, INT32 X1, INT32 X2, INT32 X, UINT32 *G)
{
    int i;
    for ( i=0; i<130; i++ )
...
static void IQS_CC_Intpl(UINT16* CC1, UINT16* CC2, INT32 X1, INT32 X2, INT32 X, UINT16 *CC)
{
    int i, E1, E2;
    for ( i=0; i<9; i++ )
    {
...
#if 1
            group->imeUpdate |= IME_SCALEQ_F_P3;
            IQ_P3Filt.CoefUserDefEn = ENABLE;
            IQ_P3Filt.UserDefine.HsfEn = ENABLE;
            IQ_P3Filt.UserDefine.VsfEn = ENABLE;
            IQ_P3Filt.UserDefine.HsfCoef = 0;
            IQ_P3Filt.UserDefine.VsfCoef = 0;

            subf->pP3_Filt = &IQ_P3Filt;
#endif
            break;
        case IQS_AE_END:
            subf->imeFuncEn |= ( ChromaFiltEn );
