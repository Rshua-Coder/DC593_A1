#ifndef IQS_SETTINGTABLE_IMX322LQJ_TVP5150_CARDV_FFFF_INT_H
#define IQS_SETTINGTABLE_IMX322LQJ_TVP5150_CARDV_FFFF_INT_H
...
extern UINT16 Normal_Day[9];
extern UINT16 Normal_CC_night[9];
