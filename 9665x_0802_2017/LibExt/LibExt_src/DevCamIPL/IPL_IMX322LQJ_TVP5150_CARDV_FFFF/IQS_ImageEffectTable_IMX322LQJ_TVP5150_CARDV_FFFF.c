#ifndef _IQS_IE_SETTINGTABLE_IMX322LQJ_TVP5150_CARDV_FFFF_C
#define _IQS_IE_SETTINGTABLE_IMX322LQJ_TVP5150_CARDV_FFFF_C
...
IQS_COLOR_EFFECT_PARAM ColorEffectTable[SEL_IMAGEEFFECT_MAX_CNT + 1] = {
  //CbOfs CrOfs YCon CCon IntOfs SatOfs HueRotate
    {128, 128,  118, 128,   8,     0,   FALSE },    //SEL_IMAGEEFFECT_OFF,
