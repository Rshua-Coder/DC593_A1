#ifndef IPL_ISR_IMX322LQJ_EVB_FF_H_
#define IPL_ISR_IMX322LQJ_EVB_FF_H_
/**
    IPL_Isr_IMX322LQJ_EVB_FF_EVB_FF_Int.h


    @file       IPL_Isr_IMX322LQJ_EVB_FF_EVB_FF_Int.h
    @ingroup    mISYSAlg
...
#endif //IPL_ISR_IMX322LQJ_EVB_FF_H_