...
//#NT#2014/12/16#Silvia Wu -begin
//#NT#
//#include "IPL_Cal_DataPassing_IMX078CQK_Sample_FF_Int.h"
//#NT#2014/12/16#Silvia Wu -end
...
#if (DMA333 == ENABLE)
    IPL_AlgSetUIInfo(IPL_SEL_RAW_BITDEPTH_PRV, SEL_RAW_BITDEPTH_12);//SIE 2 DRAM
#endif
    IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_2);
