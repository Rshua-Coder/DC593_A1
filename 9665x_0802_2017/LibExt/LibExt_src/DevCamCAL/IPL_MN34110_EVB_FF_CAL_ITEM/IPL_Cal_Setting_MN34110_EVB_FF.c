...
Cal_SENSOR_INFO SensorMode_ECS[4][SENSOR_ID_MAX_NUM] = {
    {{SENSOR_MODE_2, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_3, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_6, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_9, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
};

Cal_SENSOR_INFO SensorMode_DP[4][SENSOR_ID_MAX_NUM] = {
    {{SENSOR_MODE_2, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_3, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_6, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_9, FALSE,FALSE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
