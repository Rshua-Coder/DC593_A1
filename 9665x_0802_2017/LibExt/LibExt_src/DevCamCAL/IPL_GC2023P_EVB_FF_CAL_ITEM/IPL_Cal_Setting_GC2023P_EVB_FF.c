...
Cal_SENSOR_INFO SensorMode[2][SENSOR_ID_MAX_NUM] = {
    {{SENSOR_MODE_1, TRUE,TRUE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
    {{SENSOR_MODE_2, TRUE,TRUE,_RISING,_RISING,_RISING,0,0} , {BYPASS,0,0,0,0,0,0,0}},
};
