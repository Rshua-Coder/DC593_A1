#ifndef _IPL_CAL_SETTING_AR0330P_EVB_FF_INT_H_
#define _IPL_CAL_SETTING_AR0330P_EVB_FF_INT_H_
...
#define CalSensorModeNum    (1)
extern Cal_SENSOR_INFO SensorMode[1][SENSOR_ID_MAX_NUM];
