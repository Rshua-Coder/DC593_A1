#ifndef _IPL_CAL_DATAPASSING_AR0330P_EVB_FF_INT_H_
#define _IPL_CAL_DATAPASSING_AR0330P_EVB_FF_INT_H_
#include "IPL_HAL.h"
#include "IPL_CALRW.h"
typedef struct
{
...
extern CAL_TAG* GetCalData(CAL_SECMAP SecID);
extern void SetCalSensorMode(UINT32 Idx);
