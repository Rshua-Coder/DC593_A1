...
{
    //*** for H/W Reliability Test on EVB ***

    //650 Range is 250K Hz ~ 2M Hz
    adc_setConfig(ADC_CONFIG_ID_OCLK_FREQ, 250000); //250K Hz

    adc_open(ADC_CHANNEL_0);
    adc_setChConfig(ADC_CHANNEL_0, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_0, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_0, ADC_CH_CONFIG_ID_INTEN, FALSE);
    adc_open(ADC_CHANNEL_1);
    adc_setChConfig(ADC_CHANNEL_1, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_1, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_1, ADC_CH_CONFIG_ID_INTEN, FALSE);
    adc_open(ADC_CHANNEL_2);
    adc_setChConfig(ADC_CHANNEL_2, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_2, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_2, ADC_CH_CONFIG_ID_INTEN, FALSE);
    adc_open(ADC_CHANNEL_3);
    adc_setChConfig(ADC_CHANNEL_3, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_3, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_3, ADC_CH_CONFIG_ID_INTEN, FALSE);
    adc_open(ADC_CHANNEL_6);
    adc_setChConfig(ADC_CHANNEL_6, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_6, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_6, ADC_CH_CONFIG_ID_INTEN, FALSE);
    adc_open(ADC_CHANNEL_7);
    adc_setChConfig(ADC_CHANNEL_7, ADC_CH_CONFIG_ID_SAMPLE_FREQ, 10000); //10K Hz, sample once about 100 us for CONTINUOUS mode
    adc_setChConfig(ADC_CHANNEL_7, ADC_CH_CONFIG_ID_SAMPLE_MODE, (VOLDET_ADC_MODE) ? ADC_CH_SAMPLEMODE_CONTINUOUS : ADC_CH_SAMPLEMODE_ONESHOT);
    adc_setChConfig(ADC_CHANNEL_7, ADC_CH_CONFIG_ID_INTEN, FALSE);
...
void Dx_UninitIO(void)  // Config IO for external device
{
    ...
    adc_setEnable(FALSE);
    adc_close(ADC_CHANNEL_0);
    adc_close(ADC_CHANNEL_1);
    adc_close(ADC_CHANNEL_2);
    adc_close(ADC_CHANNEL_3);
    adc_close(ADC_CHANNEL_6);
    adc_close(ADC_CHANNEL_7);
/*
    // Disable adc control logic
    adc_setEnable(FALSE);
