...
#define VOLDET_KEY_ADC_LVL2             (90-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3             (220-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4             (385-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL5             (557-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH               (557+VOLDET_KEY_ADC_RANGE)
...
#if 0   //for screen saver, if screen is off when any key will power on the screen and cancel the key .
