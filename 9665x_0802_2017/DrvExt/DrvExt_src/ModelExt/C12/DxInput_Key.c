...
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_RANGE        (50)
#define VOLDET_KEY_ADC_LVL0         (0)
#define VOLDET_KEY_ADC_LVL1         (520-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (700-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (700+VOLDET_KEY_ADC_RANGE)
...
#endif
    //detect if power-on by press enter key
    if (rtc_getPWRStatus())
    {
