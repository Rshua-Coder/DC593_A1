...
// V = ADC*4.2/910
#define VOLDET_BATTERY_420V         651//860
#define VOLDET_BATTERY_410V         636
#define VOLDET_BATTERY_400V         620
#define VOLDET_BATTERY_390V         605//795
#define VOLDET_BATTERY_380V         589//771
#define VOLDET_BATTERY_370V         574
#define VOLDET_BATTERY_365V         566//750
#define VOLDET_BATTERY_360V         558//735
...
static UINT32 DrvPower_GetBatteryLevel(void)
{
    ...
    else
    {
        ...
        DBG_MSG(", V=%d",uiCurBatteryADC*33*2/10240);
        DBG_MSG(".%02d\r\n",(uiCurBatteryADC*33*2*100/10240)%100);
    }
