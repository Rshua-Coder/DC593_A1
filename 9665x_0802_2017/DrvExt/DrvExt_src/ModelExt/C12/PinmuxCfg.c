...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_MI5100_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_|| _SENSORLIB_ == _SENSORLIB_CMOS_OV2710_|| _SENSORLIB_ == _SENSORLIB_CMOS_IMX179_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_|| _SENSORLIB_ == _SENSORLIB_CMOS_F22P_)
