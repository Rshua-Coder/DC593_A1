...
#define GPIO_LCD_RESET              L_GPIO_19
...
#define GPIO_PWM_BLG_PCTL           PWMID_12
#define PWMID_BLG_PCTL              PWMID_12
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL           P_GPIO_48 //PWM12
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO48 
#endif

#define GPIO_HDMI_PCTL              P_GPIO_39//SB_CS2
#define PAD_HDMI_PCTL               PAD_PIN_PGPIO39
#define GPIO_CHG_CS_PCTL            P_GPIO_8//SB_CS2
#define PAD_CHG_CS_PCTL             PAD_PIN_PGPIO8
...
#define GPIO_TV_PLUG                P_GPIO_55//stone
...
#define GPIO_AUDIO_POWER            C_GPIO_10 //no use
#define GPIO_POWER_RESET			C_GPIO_11 //no use

// Wi-Fi power
#define GPIO_WIFI_POWER             P_GPIO_7//SB_CS2
#define GPIO_WIFI_SHDN              P_GPIO_43//PWM7

// Gsensor power
#define GPIO_GSENSR_PCTL  	        P_GPIO_40//PWM4 

// GPS power
#define GPIO_GPS_POWER              P_GPIO_45//PWM9
...
#define GPIO_KEY_DOWN              P_GPIO_44           //PWM8
#define PAD_KEY_DOWN               PAD_PIN_PGPIO44

#if 1 //for WD6
#define GPIO_KEY_ENTER              P_GPIO_51           // PWM15
#define PAD_KEY_ENTER               PAD_PIN_PGPIO51
#else
#define GPIO_KEY_ENTER              P_GPIO_53           // PWM17
#define PAD_KEY_ENTER               PAD_PIN_PGPIO53
#endif

#if 0   //RF IO Define
#define GPIO_RF_STD		      P_GPIO_18
#define PAD_RF_STD               PAD_PIN_PGPIO18

#define GPIO_RF_PAIRING		      P_GPIO_40
#define PAD_RF_PAIRING               PAD_PIN_PGPIO40

#define GPIO_RF_VIDEO_WIFI	      P_GPIO_17
#define PAD_RF_VIDEO_WIFI         PAD_PIN_PGPIO17

#define GPIO_RF_PHOTO_POWER      P_GPIO_41
#define PAD_RF_PHOTO_POWER         PAD_PIN_PGPIO41
#endif
/*
...
//USB CHG FULL DETECT
#define GPIO_USB_CHG_FULL           C_GPIO_14
#define PAD_USB_CHG_FULL            PAD_PIN_CGPIO14
...
#define GPIO_RED_LED                P_GPIO_52
#define PAD_RED_LED                 PAD_PIN_PGPIO52

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              C_GPIO_13
#define PAD_GREEN_LED               PAD_PIN_CGPIO13
...
#define GPIO_FOCUS_LED              P_GPIO_55       //no use
#define PAD_FOCUS_LED               PAD_PIN_PGPIO55 //no use
#define PWMID_FOCUS_LED             PWMID_6
...
#define PAD_LENS_ZOOM_PI            PAD_PIN_PGPIO55
#define PAD_LENS_ZOOM_PR            PAD_PIN_PGPIO55
