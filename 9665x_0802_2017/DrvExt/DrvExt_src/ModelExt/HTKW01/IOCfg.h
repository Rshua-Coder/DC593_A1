...
//WIFI
#define GPIO_WIFI_POWER                   P_GPIO_43//PWM7
#define GPIO_WIFI_SHDN                      P_GPIO_50//PWM14

//Motor Ctl
#define GPIO_MOTOR_CTL                      P_GPIO_49//PWM13
...
#define GPIO_KEY_VIDEO_SW           P_GPIO_48           // PWM11
#define PAD_KEY_VIDEO_SW            PAD_PIN_PGPIO48
...
#define GPIO_RED_LED               P_GPIO_44
#define PAD_RED_LED                PAD_PIN_PGPIO44   //PWR LED

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              P_GPIO_46
#define PAD_GREEN_LED               PAD_PIN_PGPIO46 // LED STATUS

#define LED_WIFI_DUMMY              0
#define LED_WIFI_BY_GPIO            1
#define LED_WIFI_CTRL               LED_WIFI_BY_GPIO
#define GPIO_WIFI_LED               P_GPIO_45
#define PAD_WIFI_LED                PAD_PIN_PGPIO45 //WIFI LED
