...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
    ...
    //Wi-Fi power
    {  GPIO_WIFI_POWER_PWM5,    GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST     }, //wifi power

	//beep
	{  GPIO_BEEP_POWER,    GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST     },//drh 20170919
};
