...
const PIN_GROUP_CONFIG vTopConfig[] =
{
...
#endif
#if (_NETWORK_ == _NETWORK_SDIO_EVB_WIFI_ || _NETWORK_ == _NETWORK_SDIO_EVB_WIFI_BRCM_)
    ...
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_10BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_SENSOR2_CFG_NONE},
...
#elif  (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_||_SENSORLIB_ == _SENSORLIB_CMOS_F02C1M_)
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
#else
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_MI5100_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_|| _SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_||_SENSORLIB_ == _SENSORLIB_CMOS_IMX208PQH_|| _SENSORLIB_ == _SENSORLIB_CMOS_F22P_)
