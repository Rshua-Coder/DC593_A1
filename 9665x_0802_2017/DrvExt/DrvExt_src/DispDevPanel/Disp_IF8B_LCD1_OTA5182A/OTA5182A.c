...
const tLCD_PARAM tMode[] =
{
    /***********       RGB Dummy-320 MODE         *************/
    {
        // tPANEL_PARAM
        {
            ...
            24.54f,                         //!< fDCLK
            1715,                          //!< uiHSyncTotalPeriod
            1440,                           //!< uiHSyncActivePeriod
            241,                            //!< uiHSyncBackPorch
            0x106,                          //!< uiVSyncTotalPeriod
            240,                            //!< uiVSyncActivePeriod
            0xd,                             //!< uiVSyncBackPorchOdd
            0xd,                             //!< uiVSyncBackPorchEven
            320,                            //!< uiBufferWidth
            240,                            //!< uiBufferHeight
            320,                            //!< uiWindowWidth
            240,                            //!< uiWindowHeight
...
const tPANEL_CMD tCmdRotateNone[] =
{
    {0x40, 0x00}
};

const tPANEL_CMD tCmdRotate180[] =
{
    {0x40, 0x03}
};
...
{
    {DISPDEV_LCD_ROTATE_NONE,   (tPANEL_CMD*)tCmdRotateNone,    1},
    {DISPDEV_LCD_ROTATE_180,    (tPANEL_CMD*)tCmdRotate180,     1}
};
//@}
...
void dispdev_writeToLcdGpio(DISPDEV_IOCTRL pDispDevControl, UINT32 addr, UINT32 value)
{
    ...
    //debug_err(("uiSIFData:%d 0x%X  0x%X\r\n",uiSIFData,addr,value));
    Delay_DelayUs(500);
